...
<div class="container mx-auto mt-6 max-w-xl">
    <h2 class="text-2xl font-bold mb-6">Adicionar Nova Disciplina</h2>

    <form method="POST" action="{{ route('admin.subjects.store') }}" class="bg-white shadow rounded p-6 space-y-4">
        @csrf
