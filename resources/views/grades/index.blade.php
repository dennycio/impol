...
@section('content')
<div class="max-w-6xl mx-auto mt-8"> {{-- <-- margem superior adicionada --}}

    {{-- Header da página separado do layout principal --}}
    <div class="bg-white p-4 rounded shadow mb-6">
        <h1 class="text-2xl font-bold text-blue-700 text-center">Lista de Notas</h1>
    </div>
