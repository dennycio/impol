<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" class="border border-blue-500 rounded-lg p-6 shadow-md bg-white max-w-md mx-auto">
        @csrf
        ...
        <div class="mt-4">
            ...
            <select id="role" name="role" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" required>
